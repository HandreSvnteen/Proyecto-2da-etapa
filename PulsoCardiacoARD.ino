...
#include <Adafruit_SSD1306.h>
  //Se crea objeto para el display OLED
Adafruit_SSD1306 srituhobby = Adafruit_SSD1306(128, 64, &Wire);
 //El pin del sensor y los parametros del pulso son definidos, las variables son creadas para el programa
#define sensor A0
...
//Función de calculo para calcular el pulso cardiaco. 
void BPM() {
